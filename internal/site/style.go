// Package site provides shared styling and helpers for slingshot deployment sites.
package site
...
// EnsureCSS writes the default style.css to siteDir if it doesn't already exist.
// If the file exists it is left untouched so the user can customise it.
func EnsureCSS(siteDir string) error {
